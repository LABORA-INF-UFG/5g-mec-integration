...
HTTPS_URL = "https://"
## Inserir o IP da VM
MEP_AGENT_URL = os.environ.get("MEP_AGENT", "127.0.0.1:6000")
SSL_ENABLED = False
...
class RestClient:
    ...
    def post(cls, url, body=None, upload_files=None):
        ...
        headers = {'Authorization': access_token, 'X-AppinstanceID': requestAccess.APP_INST_ID}
